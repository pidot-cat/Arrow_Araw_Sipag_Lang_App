...
// Level 4 — 8×8 Grid — Square Shape (full grid)
// All 64 cells are active. Arrows fill the entire 8×8 area.
...
/// 20 arrows covering 8×8 (64 cells) — mix of lengths 1,2,3
...
class _GameScreenLvl4State extends State<GameScreenLvl4> {
  ...
  void _triggerVictory() {
    ...
    context
        .read<GameProvider>()
        .recordLevelComplete(level: 4, time: 60 - _secondsLeft, lives: _lives);
  }
  ...
  void _nextLevel() => Navigator.pushReplacement(
      context, MaterialPageRoute(builder: (_) => const GameScreenLvl5()));
}
