...
class _GameScreenLvl7State extends State<GameScreenLvl7> {
  ...
  void _triggerVictory() {
    ...
    context
        .read<GameProvider>()
        .recordLevelComplete(level: 7, time: 60 - _secondsLeft, lives: _lives);
  }
  ...
  void _nextLevel() => Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const GameScreenLvl8()));
}
